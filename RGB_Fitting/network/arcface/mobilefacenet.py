...
class ConvBlock(Module):
    ...
    def __init__(self, in_c, out_c, kernel=(1, 1), stride=(1, 1), padding=(0, 0), groups=1):
        ...
        self.layers = nn.Sequential(
            ...
            BatchNorm2d(num_features=out_c), PReLU(num_parameters=out_c))
...
class LinearBlock(Module):
    ...
    def __init__(self, in_c, out_c, kernel=(1, 1), stride=(1, 1), padding=(0, 0), groups=1):
        ...
        self.layers = nn.Sequential(Conv2d(in_c, out_c, kernel, stride, padding, groups=groups, bias=False),
...
class GDC(Module):
    ...
    def __init__(self, embedding_size):
        ...
        self.layers = nn.Sequential(LinearBlock(512, 512, groups=512, kernel=(7, 7), stride=(1, 1), padding=(0, 0)),
                                    Flatten(), Linear(512, embedding_size, bias=False), BatchNorm1d(embedding_size))
