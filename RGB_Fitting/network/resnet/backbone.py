...
def conv1x1_relu(in_planes: int, out_planes: int, stride: int = 1, bias: bool = False):
    """1x1 convolution + relu"""
    conv_op = nn.Sequential(nn.Conv2d(in_planes, out_planes, kernel_size=1, stride=stride, bias=bias),
