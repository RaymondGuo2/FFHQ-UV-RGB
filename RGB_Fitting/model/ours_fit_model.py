...
class FitModel:
    ...
    def save_mesh(self, path, mesh_name, mtl_name=None, uv_name=None, is_uv_tex=True):
        ...
        if is_uv_tex:
            assert mtl_name is not None and uv_name is not None
            write_mtl(os.path.join(path, mtl_name), uv_name)
            id_mesh_info = {
